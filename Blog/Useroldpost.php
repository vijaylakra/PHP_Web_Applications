    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
				...
				<?php
                   ...
                   $pid=$_GET['pid'];
								 ...
								 $query_content = mysql_query("select * from contents where post_id<'$pid' order by date DESC")or die(mysql_error());
								 $count=0;
			...
			<ul class="pager">
					...
					<li class="next">
                        <a href="Useroldpost.php<?php echo '?pid=' .$id; ?>">Older Posts &rarr;</a>
                    </li>
					 <li class="next">
                        <a href="Userprevpost.php<?php echo '?pid=' .$pid; ?>">&larr; Previous Posts</a>
                    </li>
                </ul>
			<?php }
			else {
